...
const Sidebar = () => {
  ...
  return (
    <Box className="flex flex-col items-center bg-white border border-white-300 md:min-h-[30rem] min-h-16 h-auto md:h-[100%] w-full md:w-[16%]">
      <Box className="flex justify-between w-full items-center my-3 md:my-0 h-[3rem] md:h-[5%] ">
      ...
      <Box className="hidden md:flex flex-col mt-1 text-[18px] md:w-full truncate ">
        ...
        <Box>
          <Box className="group flex items-center h-10 my-2 rounded-br-full hover:bg-purple-400 transition-all duration-300">
          ...
          <Box className="group flex items-center h-10 rounded-br-full hover:bg-purple-400 transition-all duration-300">
            <span className="w-2 h-[100%] mr-2 group-hover:bg-violet-700"></span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="23"
